                        ...
                        <tr class="<?php echo $classe_linha ?>">
                                <td class="text-white">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <img src="<?php echo $foto?>" alt="" style="width: 45px; height: 45px" class="rounded-circle" />
                                        <div class="ms-3">
                                            <p class="fw-bold mb-1"><?php echo $nome_setor ?></p>
                                            <p class="text-white mb-1"><?php echo $nome_solicitante ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                <p class="text-white fw-bold mb-1"><?php echo $tipo_chamado ?></p>
                                </td>
                                <td>
                                <p class="text-white fw-bold mb-1"><?php echo $descricao ?></p>
                                </td>
                                <td>
                                <p class="text-white fw-bold mb-1"> <?php echo $destino ?></p>
                                </td>
                                <td>
                                <p class="text-white fw-bold mb-1"><?php echo date('d/m/Y H:m:s',  strtotime($data_atendimento)); ?></p>
                                </td>
                                <td>
                                <p class="text-white fw-bold mb-1"><?php echo $atendimento ?></p>
                                </td>
                                <td>
                                <p class="text-white fw-bold mb-1"><?php echo $nome_tecnico ?></p>
                                </td>
                        </tr>
