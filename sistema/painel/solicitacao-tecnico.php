				...
				<div class="row">
					...
					<div class="col-md-12">	
						...
						<hr>
							...
							<input type="text" class="form-control" name="km_inicial" id="km_inicial" required placeholder="inicial"> </input>
							</select>
						</div>
						<div class="form-group"> 
							<input type="text" class="form-control" name="km_final" id="km_final" required placeholder="final"> </input>
							</select>
						</div>
					</div>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<button id="btn-fechar-excluir" type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -10px">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
