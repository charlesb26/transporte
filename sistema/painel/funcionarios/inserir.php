...
$redesocial = str_replace("'", "", $redesocial);
$redesocial = str_replace("\"", "", $redesocial);
$redesocial = str_replace(array("\n", "\r"), ' ', $redesocial);
...
if($id == ""){
	$query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome, cpf = :cpf, telefone = :telefone, email = :email, endereco = :endereco, data_admissao = '$data_adm', cargo = '$cargo', setor = '$setor', obs = :obs, rede = '$rede', redesocial = :redesocial, foto = '$foto', ativo = 'Sim'");
...
$ult_id = $pdo->lastInsertId();
	...
	$query = $pdo->prepare("UPDATE $tabela SET nome = :nome, cpf = :cpf, telefone = :telefone, email = :email, endereco = :endereco, data_admissao = '$data_adm', cargo = '$cargo', setor = '$setor', obs = :obs, rede = '$rede', redesocial = :redesocial, foto = '$foto' WHERE id = '$id'");
