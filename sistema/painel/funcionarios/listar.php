...
if($total_reg > 0){
	...
	for($i=0; $i < $total_reg; $i++){
		...
		<big><a href="#" onclick="editar('{$id}', '{$nome}', '{$cpfF}', '{$telefone}', '{$email}', '{$endereco}', '{$data_admissao}', '{$cargo}', '{$setor}', '{$obs}', '{$foto}', '{$rede}', '{$redesocial}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>
...
<script type="text/javascript">
	...
	function editar(id, nome, cpf, telefone, email, endereco, data_admissao, cargo, setor, obs, foto, rede, redesocial){
