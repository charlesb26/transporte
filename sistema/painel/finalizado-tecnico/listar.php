...
if($total_reg > 0){
	...
	for($i=0; $i < $total_reg; $i++){
		...
		<big><a href="#" onclick="editar('{$id}', '{$tipo_chamado}', '{$data_atendimento}', '{$descricao}', '{$destino}', '{$atendimento}', '{$obstecnico}')" title="Parecer Técnico"><i class="fa fa-edit text-primary"></i></a></big>
...
<script type="text/javascript">
	...
	function editar(id, tipo_chamado, data_atendimento, descricao, destino, atendimento, obstecnico){
	...
	function mostrar(id, nome_solicitante, nome_setor, tipo_chamado, descricao, destino, data_atendimentoN,){	
		...
		$('#data_atendimento_mostrar').text(data_atendimentoN);
